<div class="container">
    <div class="gap"></div>
    <div class="owl-carousel" id="owl-carousel" data-items="4" data-dots="false">
        @foreach($cars as $car)
        <div>
            <div class="thumb">
                ...
                <div class="thumb-caption">
                    <h5 class="thumb-title"><a class="text-darken" href="{{ $car->reservationUrl }}">{{ $car->fullname }}</a></h5><small>{{ $car->carclass->name }}</small>
